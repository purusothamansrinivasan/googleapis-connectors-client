...
func Connectors_projects_locations_connections_entitytypes_entities_deleteentitieswithconditionsHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/v2/%s/entities:deleteEntitiesWithConditions%s", cfg.BaseURL, entityType, queryString)
...
func CreateConnectors_projects_locations_connections_entitytypes_entities_deleteentitieswithconditionsTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_v2_entityType_entities_deleteEntitiesWithConditions",
		mcp.WithDescription("Deletes entities based on conditions specified in the request and not on entity id."),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Connectors_projects_locations_connections_entitytypes_entities_deleteentitieswithconditionsHandler(cfg),
	}
}
