...
// Import Patch_V2_NameMCPTool - included in same package
// Import Get_V2_Parent_Entity_TypesMCPTool - included in same package
// Import Get_V2_Name_Check_StatusMCPTool - included in same package
// Import Post_V2_Entity_Type_Entities_Update_Entities_With_ConditionsMCPTool - included in same package
// Import Get_V2_Name_Check_ReadinessMCPTool - included in same package
// Import Post_V2_Name_Refresh_Access_TokenMCPTool - included in same package
// Import Post_V2_Entity_Type_Entities_Delete_Entities_With_ConditionsMCPTool - included in same package
// Import Post_V2_Name_Exchange_Auth_CodeMCPTool - included in same package
// Import Post_V2_Parent_EntitiesMCPTool - included in same package
// Import Get_V2_NameMCPTool - included in same package
// Import Delete_V2_NameMCPTool - included in same package
// Import Post_V2_Connection_Execute_Sql_QueryMCPTool - included in same package
// Import Post_V2_Name_ExecuteMCPTool - included in same package
// Import Get_V2_Parent_EntitiesMCPTool - included in same package
// Import Get_V2_Parent_ActionsMCPTool - included in same package
...
public class MCPServer {
    ...
    public static void main(String[] args) {
        try {
            ...
            // Register all tools
            tools = Arrays.asList(
            Patch_V2_NameMCPTool.createPatch_V2_NameTool(config),
            Get_V2_Parent_Entity_TypesMCPTool.createGet_V2_Parent_Entity_TypesTool(config),
            Get_V2_Name_Check_StatusMCPTool.createGet_V2_Name_Check_StatusTool(config),
            Post_V2_Entity_Type_Entities_Update_Entities_With_ConditionsMCPTool.createPost_V2_Entity_Type_Entities_Update_Entities_With_ConditionsTool(config),
            Get_V2_Name_Check_ReadinessMCPTool.createGet_V2_Name_Check_ReadinessTool(config),
            Post_V2_Name_Refresh_Access_TokenMCPTool.createPost_V2_Name_Refresh_Access_TokenTool(config),
            Post_V2_Entity_Type_Entities_Delete_Entities_With_ConditionsMCPTool.createPost_V2_Entity_Type_Entities_Delete_Entities_With_ConditionsTool(config),
            Post_V2_Name_Exchange_Auth_CodeMCPTool.createPost_V2_Name_Exchange_Auth_CodeTool(config),
            Post_V2_Parent_EntitiesMCPTool.createPost_V2_Parent_EntitiesTool(config),
            Get_V2_NameMCPTool.createGet_V2_NameTool(config),
            Delete_V2_NameMCPTool.createDelete_V2_NameTool(config),
            Post_V2_Connection_Execute_Sql_QueryMCPTool.createPost_V2_Connection_Execute_Sql_QueryTool(config),
            Post_V2_Name_ExecuteMCPTool.createPost_V2_Name_ExecuteTool(config),
            Get_V2_Parent_EntitiesMCPTool.createGet_V2_Parent_EntitiesTool(config),
            Get_V2_Parent_ActionsMCPTool.createGet_V2_Parent_ActionsTool(config)
            );
