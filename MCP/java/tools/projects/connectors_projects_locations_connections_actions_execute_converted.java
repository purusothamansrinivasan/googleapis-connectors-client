/**
 * MCP Server function for Executes an action with the name specified in the request. The input parameters for executing the action are passed through the body of the ExecuteAction request.
 */
...
class Post_V2_Name_ExecuteMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPost_V2_Name_ExecuteHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("parameters")) {
            queryParams.add("parameters=" + args.get("parameters"));
                ...
                String url = config.getBaseUrl() + "/api/v2/post_v2_name_execute" + queryString;
    ...
    public static MCPServer.Tool createPost_V2_Name_ExecuteTool(MCPServer.APIConfig config) {
        ...
        nameProperty.put("description", "Required. Resource name of the Action. Format: projects/{project}/locations/{location}/connections/{connection}/actions/{action}");
        ...
        parametersProperty.put("description", "Input parameter: Parameters for executing the action. The parameters can be key/value pairs or nested structs.");
        properties.put("parameters", parametersProperty);
        parameters.put("properties", properties);
        
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "post_v2_name_execute",
            "Executes an action with the name specified in the request. The input parameters for executing the action are passed through the body of the ExecuteAction request.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPost_V2_Name_ExecuteHandler(config));
    }
