/**
 * MCP Server function for Gets the schema of all the actions supported by the connector.
 */
...
class Get_V2_Parent_ActionsMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_V2_Parent_ActionsHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("prettyPrint")) {
            queryParams.add("prettyPrint=" + args.get("prettyPrint"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_v2_parent_actions" + queryString;
    ...
    public static MCPServer.Tool createGet_V2_Parent_ActionsTool(MCPServer.APIConfig config) {
        ...
        parentProperty.put("description", "Required. Parent resource name of the Action. Format: projects/{project}/locations/{location}/connections/{connection}");
        ...
        pageTokenProperty.put("description", "Page token, return from a previous ListActions call, that can be used retrieve the next page of content. If unspecified, the request returns the first page of actions.");
        ...
        viewProperty.put("description", "Specifies which fields of the Action are returned in the response.");
        ...
        pageSizeProperty.put("description", "Number of Actions to return. Defaults to 25.");
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "get_v2_parent_actions",
            "Gets the schema of all the actions supported by the connector.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getGet_V2_Parent_ActionsHandler(config));
    }
