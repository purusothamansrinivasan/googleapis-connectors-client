...
class Get_V2_Name_Check_StatusMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getGet_V2_Name_Check_StatusHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("prettyPrint")) {
            queryParams.add("prettyPrint=" + args.get("prettyPrint"));
                ...
                String url = config.getBaseUrl() + "/api/v2/get_v2_name_check_status" + queryString;
    ...
    public static MCPServer.Tool createGet_V2_Name_Check_StatusTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "get_v2_name_check_status",
            "No description available",
            parameters
        );
        
        return new MCPServer.Tool(definition, getGet_V2_Name_Check_StatusHandler(config));
    }
