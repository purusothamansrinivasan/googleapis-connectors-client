/**
 * MCP Server function for Deletes an existing entity row matching the entity type and entity id specified in the request.
 */
...
class Delete_V2_NameMCPTool {
    ...
    public static MCPServer.Tool createDelete_V2_NameTool(MCPServer.APIConfig config) {
        ...
        nameProperty.put("description", "Required. Resource name of the Entity Type. Format: projects/{project}/locations/{location}/connections/{connection}/entityTypes/{type}/entities/{id}");
