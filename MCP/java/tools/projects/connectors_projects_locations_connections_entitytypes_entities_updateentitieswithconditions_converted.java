/**
 * MCP Server function for Updates entities based on conditions specified in the request and not on entity id.
 */
...
class Post_V2_Entity_Type_Entities_Update_Entities_With_ConditionsMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPost_V2_Entity_Type_Entities_Update_Entities_With_ConditionsHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("entityType")) {
            queryParams.add("entityType=" + args.get("entityType"));
        }
        if (args.containsKey("conditions")) {
            queryParams.add("conditions=" + args.get("conditions"));
        }
        ...
        if (args.containsKey("prettyPrint")) {
            queryParams.add("prettyPrint=" + args.get("prettyPrint"));
                ...
                String url = config.getBaseUrl() + "/api/v2/post_v2_entity_type_entities_update_entities_with_conditions" + queryString;
    ...
    public static MCPServer.Tool createPost_V2_Entity_Type_Entities_Update_Entities_With_ConditionsTool(MCPServer.APIConfig config) {
        ...
        nameProperty.put("description", "Input parameter: Output only. Resource name of the Entity. Format: projects/{project}/locations/{location}/connections/{connection}/entityTypes/{type}/entities/{id}");
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "post_v2_entity_type_entities_update_entities_with_conditions",
            "Updates entities based on conditions specified in the request and not on entity id.",
            parameters
        );
        
        return new MCPServer.Tool(definition, getPost_V2_Entity_Type_Entities_Update_Entities_With_ConditionsHandler(config));
    }
