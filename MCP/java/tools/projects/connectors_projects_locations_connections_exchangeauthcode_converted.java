/**
 * MCP Server function for ExchangeAuthCode exchanges the OAuth authorization code (and other necessary data) for an access token (and associated credentials).
 */
...
class Post_V2_Name_Exchange_Auth_CodeMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPost_V2_Name_Exchange_Auth_CodeHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("prettyPrint")) {
            queryParams.add("prettyPrint=" + args.get("prettyPrint"));
                ...
                String url = config.getBaseUrl() + "/api/v2/post_v2_name_exchange_auth_code" + queryString;
    ...
    public static MCPServer.Tool createPost_V2_Name_Exchange_Auth_CodeTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "post_v2_name_exchange_auth_code",
        ...
        return new MCPServer.Tool(definition, getPost_V2_Name_Exchange_Auth_CodeHandler(config));
    }
