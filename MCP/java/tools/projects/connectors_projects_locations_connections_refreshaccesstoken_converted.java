/**
 * MCP Server function for RefreshAccessToken exchanges the OAuth refresh token (and other necessary data) for a new access token (and new associated credentials).
 */
...
class Post_V2_Name_Refresh_Access_TokenMCPTool {
    
    public static Function<MCPServer.MCPRequest, MCPServer.MCPToolResult> getPost_V2_Name_Refresh_Access_TokenHandler(MCPServer.APIConfig config) {
        return (request) -> {
            try {
        ...
        if (args.containsKey("prettyPrint")) {
            queryParams.add("prettyPrint=" + args.get("prettyPrint"));
                ...
                String url = config.getBaseUrl() + "/api/v2/post_v2_name_refresh_access_token" + queryString;
    ...
    public static MCPServer.Tool createPost_V2_Name_Refresh_Access_TokenTool(MCPServer.APIConfig config) {
        ...
        MCPServer.ToolDefinition definition = new MCPServer.ToolDefinition(
            "post_v2_name_refresh_access_token",
        ...
        return new MCPServer.Tool(definition, getPost_V2_Name_Refresh_Access_TokenHandler(config));
    }
